# Backlog - MVP (archived)

> **Archived 2026-07-15.** Every task below (DS-\*, P0-\*, P1-\*, UX-\*) shipped and merged into
> `develop`; this file is kept as the historical record of the MVP build. The active task list is
> [`../backlog.md`](../backlog.md). Do not add new work here.
