...
- Clip editor: a coach window to trim, slow down, zoom and mark up the clips of a collection
  ...
  (keyframes that hold or glide, a crop set by dragging a frame on the picture), is done; slice 4 markers with the show/hide button; slice 5 picking clips in the editor and
