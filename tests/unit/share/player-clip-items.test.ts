...
import { toPlaylistItems } from "@/features/share/player/clip-items";
import type { PlayerClipRow } from "@/features/share/player/queries";

function row(overrides: Partial<PlayerClipRow> = {}): PlayerClipRow {
  return {
    id: "clip-1",
    tagType: "goal",
    startS: 754, // 12:34
